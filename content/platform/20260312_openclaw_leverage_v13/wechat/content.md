...
**为什么有些人用了 agent 框架之后，会觉得“这东西真厉害”，而有些人用完之后，只觉得它是一个更复杂的大模型外壳？**
...
如果这些问题不清楚，它就很难从一个“很酷的框架”变成一个“真的有产出的系统”。
...
所以我现在最看重的，反而不是 OpenClaw 又多了哪个功能、又接了哪个模型。
